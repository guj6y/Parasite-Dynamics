...
table[linecolora,x =x,y =y,y error =yp,col sep = comma]{#1-effect-on-subplot-#2};
\addplot+[
		  plotoptsb,
          error bars/.cd,
		  y explicit, y dir=both,
		]
table[linecolorb,x =x,y =y,y error =yp,col sep = comma]{#1-effect-off-subplot-#2};
}
...
table[draw = none,mark =none, x =x,y expr = {\thisrow{y}+\thisrow{yp}},col sep = comma]{#1-effect-on-subplot-#2};
\addplot+[
          draw = none,
		]
table[draw = none,mark =none, x =x,y expr = {\thisrow{y}+\thisrow{yp}},col sep = comma]{#1-effect-off-subplot-#2};
\addplot+[
		  draw = none,
		]
table[draw = none,mark =none, x =x,y expr = {\thisrow{y}-\thisrow{ym}},col sep = comma]{#1-effect-on-subplot-#2};
\addplot+[
          draw = none,
		]
table[draw = none,mark =none, x =x,y expr = {\thisrow{y}-\thisrow{ym}},col sep = comma]{#1-effect-off-subplot-#2};
}
