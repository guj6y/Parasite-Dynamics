...
{; convert -density 300 -transparent white  "\image.pdf" "\image.png"; rungs -dSAFER dBATCH dNOPAUSE sDEVICE=pngalpha -dGraphicsAlphaBits=4 -r110  -sOutputFile=\image.png \image.pdf} 
}
\makeatletter
