...
\pgfplotsset{compat=newest,table/search path={../../../../data/figures,../../../../data/figures-fullBreakdown}}
...
\tikzsetnextfilename{bio-null-smallFree}
\begin{figure}
    \begin{tikzpicture}
        \begin{groupplot}[
            ...
            \setcounter{subfigure}{0}
            \nextgroupplot[legend style={name = {leg1a}}]
            \fullSplitBioPlot{null}{smallFree}{bigPara};
            \phantomFullSplitBioPlot{null}{smallFree}{smallPara};
            \nextgroupplot[legend style={name = {leg1b}}]
            \fullSplitBioPlot{null}{smallFree}{smallPara};
            \phantomFullSplitBioPlot{null}{smallFree}{bigPara};
        \end{groupplot}
            \node [inner sep = 0pt,text width =.5\linewidth,align=center,anchor=south] at (leg1a.north) {\subcaption[]{$Z_p=10^{-3}$ \label{fig:frac-bio-a}}};
            \node [inner sep = 0pt,text width =.5\linewidth,align=center,anchor=south] at (leg1b.north) {\subcaption[]{$Z_p=10^{-4}$\label{fig:frac-bio-b}}};
    \end{tikzpicture}
\end{figure}

\tikzsetnextfilename{bio-null-bigFree}
\begin{figure}
    \begin{tikzpicture}
        \begin{groupplot}[
                        group style = {group size = 2 by 1,
            ...
            \setcounter{subfigure}{0}
            \nextgroupplot[legend style={name = {leg1a}}]
            \fullSplitBioPlot{null}{bigFree}{bigPara};
            \phantomFullSplitBioPlot{null}{bigFree}{smallPara};
            \nextgroupplot[legend style={name = {leg1b}}]
            \fullSplitBioPlot{null}{bigFree}{smallPara};
            \phantomFullSplitBioPlot{null}{bigFree}{bigPara};
        \end{groupplot}
            \node [inner sep = 0pt,text width =.5\linewidth,align=center,anchor=south] at (leg1a.north) {\subcaption[]{$Z_p=10^{-3}$ \label{fig:frac-bio-a}}};
            \node [inner sep = 0pt,text width =.5\linewidth,align=center,anchor=south] at (leg1b.north) {\subcaption[]{$Z_p=10^{-4}$\label{fig:frac-bio-b}}};
    \end{tikzpicture}
...
\tikzsetnextfilename{bio-full-smallFree}
\begin{figure}
    \begin{tikzpicture}
        \begin{groupplot}[
                        group style = {group size = 2 by 1,
            ...
            \setcounter{subfigure}{0}
            \nextgroupplot[legend style={name = {leg1a}}]
            \fullSplitBioPlot{full}{smallFree}{bigPara};
            \phantomFullSplitBioPlot{full}{smallFree}{smallPara};
            \nextgroupplot[legend style={name = {leg1b}}]
            \fullSplitBioPlot{full}{smallFree}{smallPara};
            \phantomFullSplitBioPlot{full}{smallFree}{bigPara};
        \end{groupplot}
            \node [inner sep = 0pt,text width =.5\linewidth,align=center,anchor=south] at (leg1a.north) {\subcaption[]{$Z_p=10^{-3}$ \label{fig:frac-bio-a}}};
            \node [inner sep = 0pt,text width =.5\linewidth,align=center,anchor=south] at (leg1b.north) {\subcaption[]{$Z_p=10^{-4}$\label{fig:frac-bio-b}}};
    \end{tikzpicture}
...
\tikzsetnextfilename{bio-full-bigFree}
\begin{figure}
    \begin{tikzpicture}
        \begin{groupplot}[
                        group style = {group size = 2 by 1,
            ...
            \setcounter{subfigure}{0}
            \nextgroupplot[legend style={name = {leg1a}}]
            \fullSplitBioPlot{full}{bigFree}{bigPara};
            \phantomFullSplitBioPlot{full}{bigFree}{smallPara};
            \nextgroupplot[legend style={name = {leg1b}}]
            \fullSplitBioPlot{full}{bigFree}{smallPara};
            \phantomFullSplitBioPlot{full}{bigFree}{bigPara};
        \end{groupplot}
            \node [inner sep = 0pt,text width =.5\linewidth,align=center,anchor=south] at (leg1a.north) {\subcaption[]{$Z_p=10^{-3}$ \label{fig:frac-bio-a}}};
            \node [inner sep = 0pt,text width =.5\linewidth,align=center,anchor=south] at (leg1b.north) {\subcaption[]{$Z_p=10^{-4}$\label{fig:frac-bio-b}}};
    \end{tikzpicture}
