...
for ii = 1:nSims
    ...
    allBiomassTS   = sum(TS(:,:,ii));
    paraBiomassTS  = sum(TS(para,:,ii));
    freeBiomassTS  = sum(TS(free,:,ii));
    basalBiomassTS = sum(TS(basal,:,ii));
    ...
    cvAllBiomass   = meanAllBiomass./stdAllBiomass;
    cvParaBiomass  = meanParaBiomass./stdParaBiomass;
    cvFreeBiomass  = meanFreeBiomass./stdFreeBiomass;
    cvBasalBiomass = meanBasalBiomass./stdBasalBiomass;
