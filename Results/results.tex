...
\caption{This figure shows the average fraction of a species' pred that go extinct first with 95\% confidence intervals in all models with all body size configurations.\caption{fig:frac-pred-first}}
\end{figure}
