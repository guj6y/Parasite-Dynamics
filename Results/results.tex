...
\begin{figure}[h] 
\makeFigureAllSizes{persistence}{Persistence of All Species}
...
\begin{figure}[h]
\makeFigureAllSizes{free-persistence}{Persistence of Free-Livers}
...
\begin{figure}[h]
\makeFigureAllSizes{para-persistence}{Persistence of Parasites}
...
\begin{figure}[h]
\makeFigureAllSizes{frac-prey-first}{Fraction of species' prey extinct first.}
...
\begin{figure}[h]
\makeFigureAllSizes{frac-pred-first}{Fraction of a species' predators extinct first.}
...
\begin{figure}[h]
\makeFigureAllSizes{tl3-all}{Persistence of all species without an autotroph prey item.}
...
\begin{figure}[h]
\makeFigureAllSizes{tl3-free}{Persistence of free-living species without an autotroph prey item.}
...
\begin{figure}[h]
\makeFigureAllSizes{tl3-para}{Persistence of parasite species without an autotroph prey item.}
...
\begin{figure}[h]
\makeFigureAllSizes{tl2-all}{Persistence of all species with an autotroph prey item.}
