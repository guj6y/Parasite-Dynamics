...
\begin{figure}[h]
\makeFigureAllSizes{frac-prey-first}{Fraction of prey species extinct before a species}
\caption{The figure shows the persistence of parasites with 95\% confidence intervals in all models with all body size configurations.}
\label{fig:persistencePara}
\end{figure}
\begin{figure}[h]
\makeFigureAllSizes{frac-pred-first}{Fraction of a species predator extinct first.}
\caption{The figure shows the persistence of parasites with 95\% confidence intervals in all models with all body size configurations.}
\label{fig:persistencePara}
\end{figure}
